...
const NavBar = (props: Props) => {
  ...
  return (
    <div className="drawer">
      <input id="my-drawer-3" type="checkbox" className="drawer-toggle" checked={sideVisibility} onChange={toggleSideVisibility} />
   ...
   <div className="absolute top-0 left-0 h-full w-72 bg-base-100 flex flex-col">
     <ul className="menu p-4 gap-2">
       {(!isAuthenticated && (
         <>
           <li>
             <Link to="/login" className="btn bg-primary text-white" onClick={toggleSideVisibility}>
               {" "}
               <FaSignInAlt /> Sign in
             </Link>
           </li>
           <li>
             <Link to="/signup" className="btn bg-primary text-white" onClick={toggleSideVisibility}>
               <TiUserAdd /> Sign up
             </Link>
           </li>
         </>
         ...
         <>
           <li>
             <Link to="/profile" className="btn bg-primary text-white" onClick={toggleSideVisibility}>
               {" "}
               <FaUserCircle /> Profile
             </Link>
           </li>
           <li>
             <button className="btn bg-primary text-white" onClick={handleLogOut}>
               {" "}
               <BiLogOut /> Log out
             </button>
           </li>
